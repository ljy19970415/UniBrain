...
def add_weight_decay(model, image_encoder,text_encoder, fuseModule=None, weight_decay=1e-5, skip_list=()):
    decay = []
    no_decay = []
...
def create_optimizer(args, model, image_encoder,text_encoder, fuseModule=None, filter_bias_and_bn=True):
    ...
    if weight_decay and filter_bias_and_bn:
        ...
        parameters = add_weight_decay(model,image_encoder,text_encoder, fuseModule, weight_decay, skip)
        weight_decay = 0.
    else:
